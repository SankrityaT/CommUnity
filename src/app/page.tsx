...
export default function LandingPage() {
  ...
  <div className="container flex h-16 items-center justify-between px-6">
    <Link className="flex items-center space-x-3" href="/">
      ...
      <span className="font-bold text-yellow-800 text-2xl ml-2">CommUnity</span>
    </Link>
...
<section id="about-me" className="w-full py-16 bg-white text-gray-700">
  ...
  >
    ...
    {/* About Me Text */}
    <h2 className="text-3xl font-extrabold tracking-tight sm:text-4xl text-yellow-800 mb-4">
      About CommUnity
    </h2>
